...
import { CHANGE_STATUT_ACTION, CardState } from "@/store/cardReducer";
...
const CardContainer: React.FC<CardContainerProps> = ({ cards, title, onChange }) => {
    return (
...
export const  CardContainerStore = connect(
    ...
    (dispatch: Dispatch) => ({
        onChange: (card: CardState, newStatus: "ToDo" | "InProgress" | "Completed") => dispatch({
